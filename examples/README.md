...
| `fleet/tw/envelope_round.py` | Ten minutes a stop while the customer signs. When the signing is 86% of the day, the only decision left is how many couriers. Draws the round, which turns out to be compact for free. |
