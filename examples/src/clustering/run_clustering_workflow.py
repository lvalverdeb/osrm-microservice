...
#
# Every one of them sits on a road, so allocating them is a question about
# roads rather than about coordinates that happen to be in the sea -- which
# 22.6% of this corpus were until they were repositioned.
